...
$routes->get('data-baju', 'Baju::index');
$routes->get('baju/create', 'Baju::create'); 
$routes->post('baju/store', 'Baju::store'); 
$routes->post('baju/edit/(:num)', 'Baju::edit/$1');
$routes->post('baju/update/(:num)', 'Baju::update/$1');
$routes->get('baju/delete/(:num)', 'Baju::delete/$1');
